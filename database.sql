...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 21, 2024 at 02:05 AM
...
-- Procedures
--
CREATE DEFINER=`u998757727_coink`@`127.0.0.1` PROCEDURE `createUser` (IN `nombre` VARCHAR(150), IN `telefono` VARCHAR(100), IN `direccion` VARCHAR(200), IN `pais_id` INT, IN `depto_id` INT, IN `muni_id` INT)  INSERT INTO Clientes (nombre, telefono, direccion, pais_id, depto_id, muni_id)
        VALUES (nombre, telefono, direccion, pais_id, depto_id, muni_id)$$
...
INSERT INTO `Departamentos` (`id`, `data`, `country_code`) VALUES
(5, 'Antioquia', '57'),
(8, 'Atlantico', '57'),
(11, 'Bogotá', '57'),
(13, 'Bolivar', '57'),
...
(85, 'Casanare', '57'),
(86, 'Putumayo', '57'),
(88, 'San andres y providencia sta. catalina', '57'),
(91, 'Amazonas', '57'),
(94, 'Guainia', '57'),
(95, 'Guaviare', '57'),
(97, 'Vaupes', '57'),
...
(111, 'Guatemala', '502'),
(112, 'El Progreso', '502'),
(113, 'Sacatepéquez', '502'),
(114, 'Chimaltenango', '502'),
(115, 'Escuintla', '502'),
(116, 'Santa Rosa', '502'),
(117, 'Sololá', '502'),
(118, 'Totonicapán', '502'),
(119, 'Quetzaltenango', '502'),
(120, 'Suchitepéquez', '502'),
(121, 'Retalhuleu', '502'),
(122, 'San Marcos', '502'),
(123, 'Huehuetenango', '502'),
(124, 'Quiché', '502'),
(125, 'Baja verapaz', '502'),
(126, 'Alta verapaz', '502'),
(127, 'Petén', '502'),
(128, 'Izabal', '502'),
(129, 'Zacapa', '502'),
(130, 'Chiquimula', '502'),
(131, 'Jalapa', '502'),
(132, 'Jutiapa', '502'),
(521, 'Aguascalientes', '52'),
(522, 'Baja california', '52'),
(523, 'Baja california sur', '52'),
(524, 'Campeche', '52'),
(525, 'Coahuila', '52'),
(526, 'Colima', '52'),
(527, 'Chiapas', '52'),
(528, 'Chihuahua', '52'),
(529, 'Ciudad de méxico', '52'),
(530, 'Durango', '52'),
(531, 'Guanajuato', '52'),
(532, 'Guerrero', '52'),
(533, 'Hidalgo', '52'),
...
CREATE TABLE `Municipios` (
  `id` int(11) NOT NULL,
  `data` varchar(250) DEFAULT NULL,
  `depto_id` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
INSERT INTO `Municipios` (`id`, `data`, `depto_id`) VALUES
(5001, 'Medellin', '5'),
(5002, 'Abejorral', '5'),
(5004, 'Abriaqui', '5'),
(5021, 'Alejandria', '5'),
...
(68576, 'Corregimineto vijagual', '68'),
(68615, 'Rionegro', '68'),
...
INSERT INTO `Paises` (`id`, `data`, `created_at`, `updated_at`) VALUES
(52, 'MEXICO', '2023-03-13 17:16:51', '2023-03-14 17:16:51'),
(57, 'COLOMBIA', '2023-03-13 17:16:51', '2023-03-14 17:16:51'),
(58, 'VENEZUELA', '2023-03-13 17:16:51', '2023-03-14 17:16:51'),
(502, 'GUATEMALA', '2023-03-13 17:16:51', '2023-03-14 17:16:51');
...
--
ALTER TABLE `Usuarios`
  ADD CONSTRAINT `Usuarios_ibfk_1` FOREIGN KEY (`pais_id`) REFERENCES `Paises` (`id`),
  ADD CONSTRAINT `Usuarios_ibfk_2` FOREIGN KEY (`deptp_id`) REFERENCES `Departamentos` (`id`),
  ADD CONSTRAINT `Usuarios_ibfk_3` FOREIGN KEY (`muni_id`) REFERENCES `Municipios` (`id`);
COMMIT;
